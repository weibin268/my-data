...
public class SassModifyBaseVisitor {
    ...
    private List<SassModifyBaseVisitor.TableInfo> tableInfoList;
    private String fieldName;
    private Supplier<String> valueSupplier;

    public SassModifyBaseVisitor(List<SassModifyBaseVisitor.TableInfo> tableInfoList, String fieldName, Supplier<String> valueSupplier, String dbType) {
    ...
    public void visit4HasWhere(Object target, SQLTableSource tableSource) {
        if (tableSource instanceof SQLExprTableSource) {
            ...
            SassModifyBaseVisitor.TableInfo tableInfo = getTableInfoByName(exprTableSource.getName());
            if (tableInfo != null) {
            ...
            if (leftTableSource instanceof SQLExprTableSource) {
                ...
                SassModifyBaseVisitor.TableInfo tableInfo = getTableInfoByName(leftExprTableSource.getName());
                if (tableInfo != null) {
            ...
            if (rightTableSource instanceof SQLExprTableSource) {
                ...
                SassModifyBaseVisitor.TableInfo tableInfo = getTableInfoByName(rightExprTableSource.getName());
                if (tableInfo != null) {
    ...
    private void modify4HasWhere(Object target, SassModifyBaseVisitor.TableInfo tableInfo, String alias) {
    ...
    private SassModifyBaseVisitor.TableInfo getTableInfoByName(SQLName tableName) {
        return getTableInfoByName(tableName.getSimpleName());
    }

    private SassModifyBaseVisitor.TableInfo getTableInfoByName(String tableName) {
